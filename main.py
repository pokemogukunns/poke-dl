...
max_time = 9.9
apis = [r"https://inv.zzls.xyz/",r"https://inv.nadeko.net/",r"https://invidious.pcgamingfreaks.at/",r"https://youtube.mosesmang.com/"]
apidesu = [r"https://invidious.pcgamingfreaks.at/api/v1/videos/",r"https://youtube.mosesmang.com/api/v1/videos/",r"https://vercel-tau-lac-41.vercel.app/get-video-data/",r"https://inv.nadeko.net/api/v1/videos/"]
...
def video(v:str,response: Response,request: Request,yuki: Union[str] = Cookie(None),proxy: Union[str] = Cookie(None)):
    ...
    t = get_data(videoid)
    response.set_cookie("yuki","True",max_age=60 * 60 * 24 * 7)
    return template('api.html', {"request": request,"videoid":videoid,"videourls":t[1],"res":t[0],"description":t[2],"videotitle":t[3],"authorid":t[4],"authoricon":t[6],"author":t[5],"proxy":proxy})
